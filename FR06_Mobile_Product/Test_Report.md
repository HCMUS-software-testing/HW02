# Test Report - FR-06: Mobile App Product detail view
...
| Variable | Valid Classes | Invalid Classes | Reason |
| :--- | :--- | :--- | :--- |
| ... | ... | ... | ... |

### 1.3. Combination Matrix & Select Representative Values
| Scenario ID | Variable 1 | Variable 2 | Expected Outcome |
| :--- | :--- | :--- | :--- |
| ... | ... | ... | ... |
