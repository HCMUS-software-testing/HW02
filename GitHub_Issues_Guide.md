...
## 1. BUG-FR04-01: Leo thang đặc quyền qua Mass Assignment

* **Tiêu đề (Title):** `[BUG-FR04-01] Leo thang đặc quyền qua thuộc tính role khi cập nhật thông tin cá nhân`
* **Nội dung phần mô tả (Issue Body):**
...
## 2. BUG-FR04-02: Mất dữ liệu khi cập nhật một phần (Data Loss on Partial Update)

* **Tiêu đề (Title):** `[BUG-FR04-02] Mất dữ liệu - Cập nhật thiếu trường khi cập nhật thông tin cá nhân sẽ ghi đè giá trị cũ bằng NULL`
* **Nội dung phần mô tả (Issue Body):**
...
## 3. BUG-FR04-03: Thiếu kiểm tra dữ liệu đầu vào (Lack of Input Validation)

* **Tiêu đề (Title):** `[BUG-FR04-03] Thiếu kiểm duyệt dữ liệu đầu vào khi cập nhật thông tin cá nhân`
* **Nội dung phần mô tả (Issue Body):**
...
## 4. BUG-FR04-04: Lộ lọt thông tin nhạy cảm (Sensitive Data Exposure)

* **Tiêu đề (Title):** `[BUG-FR04-04] Lộ lọt thông tin người dùng nhạy cảm khi lấy thông tin cá nhân`
* **Nội dung phần mô tả (Issue Body):**
...
## 5. BUG-FR04-05: Lỗi định dạng Regex ở Frontend chặn số điện thoại hợp lệ

* **Tiêu đề (Title):** `[BUG-FR04-05] Giao diện người dùng chặn cập nhật các số điện thoại Việt Nam hợp lệ bắt đầu bằng số 0`
* **Nội dung phần mô tả (Issue Body):**
...
## Kết quả thực tế
- Trình duyệt hiển thị thông báo alert: *"Số điện thoại không hợp lệ. Vui lòng nhập đúng 9-10 chữ số."* và chặn toàn bộ tiến trình cập nhật tên hoặc địa chỉ của người dùng.
